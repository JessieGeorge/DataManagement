...
String friendUsername = request.getParameter("friendUsername").toString();
%>
<b>Auction History for your friend <%= friendUsername %> </b> 
<br></br>
...
try 
{
        ...
        pt1.setString(1, friendUsername);
        ResultSet rs1 = pt1.executeQuery();
%>
<br></br>
<b>Vehicles they bought:</b> 
<br></br>
...
<%      
        ...
        pt2.setString(1, friendUsername);
...
<%      
        ...
        pt3.setString(1, friendUsername);
...
<%      
        ...
        pt4.setString(1, friendUsername);
